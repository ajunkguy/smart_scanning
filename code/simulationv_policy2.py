...
def start_test():
    ...
    for i in range(int(60*24*30*12*10/ac)):
        ...
        while(frequency_sum7>1):
            ...
            device_mat7[int(target/ip_pool_min_range),result] += 1
        ...
        print('collect...',i/test_time_range,'/',100)
        #先收集100轮信息
        if i/test_time_range>=100:
            break
    
    
    print('device_mat7[0]',device_mat7[0])
    

    test_time_range = int(24*60*one_time_cost_hour2/24/ac)#扫描一遍所需花费的时间
    ...
    for i in range(int(60*24*30*12*10/ac)):
        ...
        while(frequency_sum7>1):
            ...
            if ip_memory7[target] == device_class_num:
                white_cishu7 += 1
        ...
        if i%test_time_range == test_time_range-1:  
            ...
            print('cishu:',cishu1,cishu5,cishu7)
            print('white_cishu',white_cishu1,white_cishu5,white_cishu7)
...
写数据
'''
wfile = open('result4.txt', 'w') #清空文件内容再写
...
for i_time in range(1,21):
    ...
    one_time_cost_hour2 = ipnum / (per_s*60*60)
    print('one_time_cost_hour2',one_time_cost_hour2)
    test_time_range = int(24*60*one_time_cost_hour2/24/ac)#扫描一遍所需花费的时间
